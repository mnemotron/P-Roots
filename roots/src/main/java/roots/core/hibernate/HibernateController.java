...
//	public final static String c_hd_derby = "org.hibernate.dialect.DerbyDialect";
//	public final static String c_dc_embedded_derby = "org.apache.derby.jdbc.EmbeddedDriver";
...
//	private final static String c_prop_hibernate_connection_datasource_name = "hibernate.connection.datasource";
...
//	public static HibernateController getHibernateControllerInstance(HibernateController.databases p_database, String p_dblocation, String p_dbname, String p_dbusername, String p_dbpassword) throws Exception
//	{
//		if (HibernateController.hibernatecontroller == null)
//		{
//			HibernateController.hibernatecontroller = new HibernateController(p_database, p_dblocation, p_dbname, p_dbusername, p_dbpassword);
//		}
//
//		return HibernateController.hibernatecontroller;
//	}

	public HibernateController(HibernateController.databases p_database, String p_dblocation, String p_dbname, String p_dbusername, String p_dbpassword) throws Exception
	{
		...
		configuration.setProperty(c_prop_hibernate_transaction_factory_class, "org.hibernate.transaction.JDBCTransactionFactory");
...
//		configuration.setProperty(c_prop_hibernate_connection_datasource_name, c_curl_forfedredb);
	...
	private void setConfigEmbeddedMySQL(HibernateController.databases p_database, String p_dblocation, String p_dbname, String p_dbusername, String p_dbpassword)
	{
	...
	private void setConfigEmbeddedForfedreDB()
	{
		...
		this.setHibernateConnectionUrl(HibernateController.c_curl_protocol_jdbc_hsqldb + HibernateController.c_loc_forfedredb + HibernateController.c_curl_forfedredb + HibernateController.c_curl_hsqldb_create);
