...
public class GUIRepositoryLogin extends JPanel
{
    ...
    protected static final String c_btn_db_connect1 = "BTN_DB_CONNECT1";
    protected static final String c_btn_db_connect2 = "BTN_DB_CONNECT2";
    protected static final String c_btn_rep_choose1 = "BTN_REP_CHOOSE1";
    protected static final String c_btn_rep_choose2 = "BTN_REP_CHOOSE2";
    private static final String c_tab_title_property = "TAB_TITLE_DB_LOGIN";
    ...
    private JLabel lbl_account_ico;
	...
	if (panel_repmain == null)
	{
	    ...
	    gl_panel_repmain.setHorizontalGroup(gl_panel_repmain.createParallelGroup(Alignment.TRAILING)
		    .addGroup(gl_panel_repmain.createSequentialGroup().addGroup(gl_panel_repmain
			    .createParallelGroup(Alignment.TRAILING)
			    .addGroup(gl_panel_repmain.createSequentialGroup().addContainerGap()
			    ...
			    .addGroup(gl_panel_repmain.createParallelGroup(Alignment.TRAILING)
				    ...
				    .addGroup(gl_panel_repmain.createSequentialGroup().addGap(4)
					    .addGroup(gl_panel_repmain.createParallelGroup(Alignment.LEADING)
						    .addComponent(getPanel_1(), GroupLayout.DEFAULT_SIZE, 381,
							    Short.MAX_VALUE)
						    .addComponent(getPanel_repdb(), GroupLayout.DEFAULT_SIZE, 381,
							    Short.MAX_VALUE)
						    .addComponent(getPanel_rep(), GroupLayout.DEFAULT_SIZE, 381,
							    Short.MAX_VALUE)))))
			    .addGap(18)
			    .addGroup(gl_panel_repmain.createParallelGroup(Alignment.LEADING)
				    .addComponent(getLblNewLabel()).addComponent(getLbl_account_ico(),
					    GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE))
			    .addGap(16)));
	    gl_panel_repmain.setVerticalGroup(gl_panel_repmain.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_repmain.createSequentialGroup().addGroup(gl_panel_repmain
			    .createParallelGroup(Alignment.LEADING)
			    .addGroup(gl_panel_repmain.createSequentialGroup().addGap(11)
				    .addComponent(getPanel_repdb(), GroupLayout.PREFERRED_SIZE, 107,
					    GroupLayout.PREFERRED_SIZE)
				    .addGap(18)
				    .addComponent(getPanel_1(), GroupLayout.PREFERRED_SIZE, 104,
					    GroupLayout.PREFERRED_SIZE)
				    .addPreferredGap(ComponentPlacement.RELATED).addComponent(getBtn_db_connect())
				    .addGap(46)
				    .addComponent(getPanel_rep(), GroupLayout.PREFERRED_SIZE, 227,
					    GroupLayout.PREFERRED_SIZE)
				    .addPreferredGap(ComponentPlacement.RELATED).addComponent(getBtn_rep_choose()))
			    .addGroup(gl_panel_repmain.createSequentialGroup().addGap(36).addComponent(getLblNewLabel())
				    .addGap(63).addComponent(getLbl_account_ico())))
	...
	this.guireplogincontroller.changeTabTitle(tp.getLanguagePropertie(c_tab_title_property));
	...
	if (this.btn_db_connect.getName().compareTo(GUIRepositoryLogin.c_btn_db_connect1) == 0)
	{
	    this.btn_db_connect.setText(tp.getLanguagePropertie(GUIRepositoryLogin.c_btn_db_connect1));
	} else if (this.btn_db_connect.getName().compareTo(GUIRepositoryLogin.c_btn_db_connect2) == 0)
	{
	    this.btn_db_connect.setText(tp.getLanguagePropertie(GUIRepositoryLogin.c_btn_db_connect2));
	}

	if (this.btn_rep_choose.getName().compareTo(GUIRepositoryLogin.c_btn_rep_choose1) == 0)
	{
	    this.btn_rep_choose.setText(tp.getLanguagePropertie(GUIRepositoryLogin.c_btn_rep_choose1));
	} else if (this.btn_rep_choose.getName().compareTo(GUIRepositoryLogin.c_btn_rep_choose2) == 0)
	{
	    this.btn_rep_choose.setText(tp.getLanguagePropertie(GUIRepositoryLogin.c_btn_rep_choose2));
	}
    }
    ...
    private JLabel getLbl_account_ico()
    {
	if (lbl_account_ico == null)
	{
	    lbl_account_ico = new JLabel("");
	    lbl_account_ico.setIcon(
		    new ImageIcon(GUIRepositoryLogin.class.getResource(SystemResourceIcons.ICON_REPOSITORY_ACCOUNT)));
	}
	return lbl_account_ico;
    }
	...
	if (panel_repdb == null)
	{
	    ...
	    gl_panel_repdb.setHorizontalGroup(gl_panel_repdb.createParallelGroup(Alignment.TRAILING)
		    .addGroup(gl_panel_repdb.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_repdb.createParallelGroup(Alignment.LEADING)
				    .addComponent(getLbl_db_location()).addComponent(getLbl_db_name())
				    .addComponent(getLbl_database()))
			    .addPreferredGap(ComponentPlacement.RELATED)
			    .addGroup(gl_panel_repdb.createParallelGroup(Alignment.TRAILING)
				    .addComponent(getTxf_db_location(), GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
				    .addComponent(getTxf_db_name(), Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 193,
					    Short.MAX_VALUE)
				    .addComponent(getCbx_database(), Alignment.LEADING, 0, 193, Short.MAX_VALUE))
			    .addContainerGap()));
	    gl_panel_repdb.setVerticalGroup(gl_panel_repdb.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_repdb.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_repdb.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getCbx_database(), GroupLayout.PREFERRED_SIZE,
					    GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				    .addComponent(getLbl_database()))
			    .addGap(11)
			    .addGroup(gl_panel_repdb.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getTxf_db_location(), GroupLayout.PREFERRED_SIZE, 21,
					    GroupLayout.PREFERRED_SIZE)
				    .addComponent(getLbl_db_location()))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addGroup(gl_panel_repdb.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getTxf_db_name(), GroupLayout.PREFERRED_SIZE, 20,
					    GroupLayout.PREFERRED_SIZE)
				    .addComponent(getLbl_db_name()))
	...
	if (panel_repaccount == null)
	{
	    ...
	    gl_panel_repaccount.setHorizontalGroup(gl_panel_repaccount.createParallelGroup(Alignment.TRAILING)
		    .addGroup(Alignment.LEADING, gl_panel_repaccount.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_repaccount.createParallelGroup(Alignment.LEADING, false)
				    .addComponent(getLbl_account_username()).addComponent(getLbl_account_password()))
			    .addPreferredGap(ComponentPlacement.RELATED)
			    .addGroup(gl_panel_repaccount.createParallelGroup(Alignment.LEADING)
				    .addComponent(getCbx_account_spass())
				    .addComponent(getTextField_1_1(), Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 193,
					    Short.MAX_VALUE)
				    .addComponent(getTextField_1(), Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 193,
					    Short.MAX_VALUE))
			    .addContainerGap()));
	    gl_panel_repaccount.setVerticalGroup(gl_panel_repaccount.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_repaccount.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_repaccount.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getTextField_1(), GroupLayout.PREFERRED_SIZE, 21,
					    GroupLayout.PREFERRED_SIZE)
				    .addComponent(getLbl_account_username()))
			    .addGap(14)
			    .addGroup(gl_panel_repaccount.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getTextField_1_1(), GroupLayout.PREFERRED_SIZE, 21,
					    GroupLayout.PREFERRED_SIZE)
				    .addComponent(getLbl_account_password()))
			    .addPreferredGap(ComponentPlacement.UNRELATED).addComponent(getCbx_account_spass())
	...
	if (panel_rep == null)
	{
	    ...
	    gl_panel_rep.setHorizontalGroup(gl_panel_rep.createParallelGroup(Alignment.TRAILING)
		    .addGroup(gl_panel_rep.createSequentialGroup().addContainerGap().addComponent(getLbl_repname())
			    .addGap(14)
			    .addGroup(gl_panel_rep.createParallelGroup(Alignment.LEADING)
				    .addComponent(getPanel_1_2(), GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
				    .addGroup(Alignment.TRAILING, gl_panel_rep.createSequentialGroup()
					    .addComponent(getCbx_repname(), 0, 238, Short.MAX_VALUE)
					    .addPreferredGap(ComponentPlacement.RELATED).addComponent(getBtn_repnew(),
						    GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)))
			    .addContainerGap()));
	    gl_panel_rep.setVerticalGroup(gl_panel_rep.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_rep.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_rep.createParallelGroup(Alignment.LEADING)
				    .addGroup(gl_panel_rep.createParallelGroup(Alignment.BASELINE)
					    .addComponent(getCbx_repname(), GroupLayout.PREFERRED_SIZE,
						    21, GroupLayout.PREFERRED_SIZE)
					    .addComponent(getLbl_repname(), GroupLayout.PREFERRED_SIZE, 17,
						    GroupLayout.PREFERRED_SIZE))
				    .addComponent(getBtn_repnew(), GroupLayout.PREFERRED_SIZE, 21,
					    GroupLayout.PREFERRED_SIZE))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addComponent(getPanel_1_2(), GroupLayout.PREFERRED_SIZE, 158, Short.MAX_VALUE)
			    .addContainerGap()));
	...
	if (btn_db_connect == null)
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
		    if (btn_db_connect.getName().compareTo(GUIRepositoryLogin.c_btn_db_connect1) == 0)
		    {
			guireplogincontroller.loginDatabase();
		    } else if (btn_db_connect.getName().compareTo(GUIRepositoryLogin.c_btn_db_connect2) == 0)
		    {
	...
	if (btn_rep_choose == null)
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
		    if (btn_rep_choose.getName().compareTo(GUIRepositoryLogin.c_btn_rep_choose1) == 0)
		    {
			// choose
			guireplogincontroller.chooseRepository();

		    } else if (btn_rep_choose.getName().compareTo(GUIRepositoryLogin.c_btn_rep_choose2) == 0)
		    {
			// create
	...
	if (panel_repinfo == null)
	{
	    ...
	    gl_panel_repinfo.setHorizontalGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_repinfo.createSequentialGroup().addContainerGap()
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING, false)
				    .addComponent(getLbl_repcreationdate(), GroupLayout.DEFAULT_SIZE,
					    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				    .addComponent(getLbl_repversion()).addComponent(getLbl_repcreator())
				    .addComponent(getLbl_repdescription(), GroupLayout.DEFAULT_SIZE,
					    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
				    .addComponent(getTxp_repdescription_dat(), GroupLayout.DEFAULT_SIZE, 193,
					    Short.MAX_VALUE)
				    .addComponent(getLbl_repcreationdate_dat())
				    .addComponent(getLbl_repversion_dat(), GroupLayout.PREFERRED_SIZE, 33,
					    GroupLayout.PREFERRED_SIZE)
				    .addComponent(getTxt_repcreator(), GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE))
			    .addContainerGap()));
	    gl_panel_repinfo.setVerticalGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
		    .addGroup(gl_panel_repinfo.createSequentialGroup()
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getLbl_repversion_dat()).addComponent(getLbl_repversion()))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getLbl_repcreationdate_dat()).addComponent(getLbl_repcreationdate()))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
				    .addComponent(getLbl_repcreator()).addComponent(getTxt_repcreator(),
					    GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
			    .addPreferredGap(ComponentPlacement.UNRELATED)
			    .addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
				    .addGroup(gl_panel_repinfo.createSequentialGroup()
					    .addComponent(getLbl_repdescription()).addContainerGap(90, Short.MAX_VALUE))
				    .addComponent(getTxp_repdescription_dat(), GroupLayout.DEFAULT_SIZE, 104,
					    Short.MAX_VALUE))));
	...
	if (btn_repnew == null)
	{
	    ...
	    btn_repnew.setIcon(
		    new ImageIcon(GUIRepositoryLogin.class.getResource(SystemResourceIcons.ICON_REPOSITORY_CREATE)));
	}
	return btn_repnew;
    }
	...
	if (lblNewLabel == null)
	{
	    ...
	    lblNewLabel.setIcon(
		    new ImageIcon(GUIRepositoryLogin.class.getResource(SystemResourceIcons.ICON_REPOSITORY_LOGIN)));
	}
	return lblNewLabel;
    }
