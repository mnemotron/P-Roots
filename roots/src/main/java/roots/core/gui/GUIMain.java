...
public class GUIMain
{
    ...
    public GUIMain(GUICMain p_guimaincontroller)
    {
	...
	if (mi_forfedre_exit == null)
	{
	    ...
	    mi_forfedre_exit
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_ROOTS_EXIT)));
	...
	if (menu_programs == null)
	{
	    ...
	    menu_programs.setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_PROGRAMS)));
	...
	if (menu_programs_edit == null)
	{
	    ...
	    menu_programs_edit
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_PROGRAMS)));
	...
	if (menu_repository == null)
	{
	    ...
	    menu_repository.setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_REPOSITORY)));
	...
	if (mi_repository_info == null)
	{
	    ...
	    mi_repository_info
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_REPOSITORY_INFO)));
	...
	if (mi_repository_change == null)
	{
	    ...
	    mi_repository_change
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_REPOSITORY_CHANGE)));
	...
	if (mi_language_german == null)
	{
	    ...
	    mi_language_german
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_LANGUAGE_DE)));
	...
	if (mi_language_english == null)
	{
	    ...
	    mi_language_english
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_LANGUAGE_EN)));
	...
	{
	    menu_info = new JMenu("");
	    menu_info.setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_INFO)));
	...
	if (mi_info_help == null)
	{
	    ...
	    mi_info_help.setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_INFO_HELP)));
	...
	if (lbl_repository_status == null)
	{
	    ...
	    lbl_repository_status
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_REPO_DB_STATUS_NATIVE)));
	...
	if (mi_info_errordisplay == null)
	{
	    ...
	    mi_info_errordisplay
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_INFO_LOG)));
	...
	if (menu_repimport == null)
	{
	    ...
	    menu_repimport
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_REPOSITORY_IMPORT)));
	...
	if (menu_repexport == null)
	{
	    ...
	    menu_repexport
		    .setIcon(new ImageIcon(GUIMain.class.getResource(SystemResourceIcons.ICON_MENU_REPOSITORY_EXPORT)));
