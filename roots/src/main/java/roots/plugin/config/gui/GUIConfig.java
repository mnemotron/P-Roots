...
public class GUIConfig extends JPanel
{
	...
	private static final String TAG_TAB_TITLE = "TAB_TITLE_CONFIG";
	private static final String MI_ROOTS_CONFIG_TREE_ITEM_LAF = "MI_ROOTS_CONFIG_TREE_ITEM_LAF";
	private GUICConfig guiconfigcontroller;
	private JXTree tree;
	private JSplitPane splitPane;

	public GUIConfig(GUICConfig guiconfigcontroller)
	{
		this.guiconfigcontroller = guiconfigcontroller;
	...
	{
		// change tab title
		this.guiconfigcontroller.changeTabTitle(tp.getLanguagePropertie(GUIConfig.TAG_TAB_TITLE));
		...
		for (int i = 0; i < count; i++)
		{
			...
			treeEntity.setNodeDescription(tp.getLanguagePropertie(GUIConfig.MI_ROOTS_CONFIG_TREE_ITEM_LAF));
		}
	...
	{
		TreeEntity te = new TreeEntity("Look And Feel", TreeEntity.NodeID.CONFIG_LOOK_AND_FEEL, SystemResourceIcons.ICON_CONFIG_TREE_LEAF_LOOKANDFEEL);
