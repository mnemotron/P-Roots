...
public class GUIRepositoryLogin extends JPanel
{
	 ...
	 * Create the panel.
	 */
	public GUIRepositoryLogin(GUIRepositoryLoginController p_guireplogincontroller)
	{
				...
				gl_panel_repmain.createParallelGroup(Alignment.TRAILING)
					.addGroup(gl_panel_repmain.createSequentialGroup()
						...
						.addGroup(gl_panel_repmain.createParallelGroup(Alignment.LEADING)
							...
							.addComponent(getLbl_account_ico(), GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE))
						.addGap(16))
			);
				...
				gl_panel_repmain.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panel_repmain.createSequentialGroup()
						.addGroup(gl_panel_repmain.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_panel_repmain.createSequentialGroup()
								.addGap(11)
								.addComponent(getPanel_repdb(), GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
								.addGap(18)
							...
							.addGroup(gl_panel_repmain.createSequentialGroup()
								...
								.addComponent(getLblNewLabel())
								.addGap(63)
								.addComponent(getLbl_account_ico())))
	...
	protected JComboBox getCbx_database()
	{
		...
		{
			cbx_database = new JComboBox(new ComboBoxKeyModel());
	...
	private JLabel getLbl_account_ico()
	{
		if (lbl_account_ico == null)
		{
			...
			lbl_account_ico.setIcon(new ImageIcon(GUIRepositoryLogin.class.getResource("/roots/icons/repositorylogin/account64.png")));
		}
	...
	private JPanel getPanel_rep()
	{
		if (panel_rep == null)
		{
			...
			gl_panel_rep.setHorizontalGroup(
				gl_panel_rep.createParallelGroup(Alignment.TRAILING)
					.addGroup(gl_panel_rep.createSequentialGroup()
						.addContainerGap()
						.addComponent(getLbl_repname())
						.addGap(14)
						.addGroup(gl_panel_rep.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(Alignment.TRAILING, gl_panel_rep.createSequentialGroup()
								...
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(getBtn_repnew(), GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)))
						.addContainerGap())
			);
			gl_panel_rep.setVerticalGroup(
				gl_panel_rep.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panel_rep.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_panel_rep.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_panel_rep.createParallelGroup(Alignment.BASELINE)
								.addComponent(getCbx_repname(), GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
								.addComponent(getLbl_repname(), GroupLayout.PREFERRED_SIZE, 17, GroupLayout.PREFERRED_SIZE))
							.addComponent(getBtn_repnew(), GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE))
	...
	protected JComboBox getCbx_repname()
	{
		if (cbx_repname == null)
		{
			cbx_repname = new JComboBox(new ComboBoxRepKeyModel());
	...
	private JPanel getPanel_1_2()
	{
		if (panel_repinfo == null)
		{
			...
			gl_panel_repinfo.setHorizontalGroup(
				gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panel_repinfo.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING, false)
							.addComponent(getLbl_repcreationdate(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addComponent(getLbl_repversion())
							.addComponent(getLbl_repcreator())
							.addComponent(getLbl_repdescription(), GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
							.addComponent(getTxp_repdescription_dat(), GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
							.addComponent(getLbl_repcreationdate_dat())
							.addComponent(getLbl_repversion_dat(), GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE)
							.addComponent(getTxt_repcreator(), GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE))
						.addContainerGap())
			);
			gl_panel_repinfo.setVerticalGroup(
				gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panel_repinfo.createSequentialGroup()
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
							.addComponent(getLbl_repversion_dat())
							.addComponent(getLbl_repversion()))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
							.addComponent(getLbl_repcreationdate_dat())
							.addComponent(getLbl_repcreationdate()))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.BASELINE)
							.addComponent(getLbl_repcreator())
							.addComponent(getTxt_repcreator(), GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_repinfo.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_panel_repinfo.createSequentialGroup()
								.addComponent(getLbl_repdescription())
								.addContainerGap(90, Short.MAX_VALUE))
							.addComponent(getTxp_repdescription_dat(), GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)))
			);
	...
	protected JButton getBtn_repnew() {
		if (btn_repnew == null) {
			...
			btn_repnew.setIcon(new ImageIcon(GUIRepositoryLogin.class.getResource("/roots/icons/repcreate.png")));
		}
		return btn_repnew;
	}
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setIcon(new ImageIcon(GUIRepositoryLogin.class.getResource("/roots/icons/repositorylogin/dblogin.png")));
		}
		return lblNewLabel;
	}
